...
class Profiles:
    ...
    def __init__(self):
        ...
        print(profile_data)
        if profile_data:
            self.profiles = [Profile(email=p['email'], password=p['password'], id=p['_id'], auth_token=p['auth_token'], payment_method_id=p['payment_method_id']) for p in profile_data]
...
class Profile:
    ...
    def __init__(self, email=None, password=None, id=None, auth_token=None, payment_method_id=None):
        self.email = email
